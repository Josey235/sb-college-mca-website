  ...
  return (
    ...
    >
      ...
      <div className="relative h-[300px] overflow-hidden bg-[#ded7cd]">
        ...
        <div
          className="
            pointer-events-none absolute -left-10 bottom-1
            h-20 w-40
            rounded-full
            bg-[#f1ede7]/90
            blur-3xl
        ...
        <div
          className="
            pointer-events-none absolute left-1/4 bottom-0
            h-24 w-48
            rounded-full
            bg-[#f1ede7]/95
            blur-3xl
        ...
        <div
          className="
            pointer-events-none absolute -right-10 bottom-1
            h-20 w-40
            rounded-full
            bg-[#f1ede7]/90
            blur-3xl
      ...
      <div className="relative -mt-12 px-5 pb-5 text-center">
        ...
        {/* Roll Number */}
        <p className="mt-1 text-[11px] font-medium text-[#987a5f]">
          {student.roll_number || 'MCA Scholar'}
        </p>
        ...
        <p
          className="
            mx-auto mt-2 min-h-[34px] max-w-[260px]
