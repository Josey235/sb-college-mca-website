        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-card text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-600 text-sm max-w-lg mx-auto leading-relaxed">
              The MCA programme was newly started in 2026. Student awards, research publications, hackathon participations, and departmental milestones for the <strong>MCA Batch 2026–2028</strong> will be highlighted here.
            </p>
          </div>
